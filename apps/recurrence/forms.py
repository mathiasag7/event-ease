...
class RecurrenceWidget(forms.Textarea):
    ...
    def get_media(self):
        ...
        js = [
            ...
            staticfiles_storage.url('c-recurrence/js/recurrence.js'),
            staticfiles_storage.url('c-recurrence/js/recurrence-widget.js'),
            staticfiles_storage.url('c-recurrence/js/recurrence-widget.init.js'),
        ]
        ...
        return forms.Media(
            js=js, css={
                'all': (
                    staticfiles_storage.url('c-recurrence/css/recurrence.css'),
                ),
            },
        )
